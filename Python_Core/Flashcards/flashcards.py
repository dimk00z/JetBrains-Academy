...
class Flashcard:
    ...
    def get_hardest_card(self):
        ...
        if max_errors == 0:
            ...
            return
        cards_with_max_errors = [
            card for card in self.cards if card.errors == max_errors
        ]
    ...
    def remove_card(self):
        ...
        if term not in self.terms:
            print(
                self._add_log_line(f"""Can't remove "{term}": there is no such card.""")
            )
        else:
    ...
    def add_card(self):
        ...
        while term in self.terms:
            term = input(
                self._add_log_line(f'The card "{term}" already exists. Try again:\n')
            )
    ...
    def check_cards(self):
        ...
        for card in itertools.cycle(self.cards):
            ...
            user_input: str = input(
                self._add_log_line(f'Print the definition of "{card.term}":\n')
            )
    ...
    def check_user_input(
        self, user_input: str, definition: str
...
class FlashcardArgParser:
    def __init__(self):
        ...
        self.parser.add_argument("--import_from", default=None, help="File for loading")
        self.parser.add_argument("--export_to", default=None, help="File for export")
        self.parse_args()
